        ...
        <div className="p-6 space-y-6">
          ...
          {slide === 0 && (
            <div className="space-y-3 text-center">
              <h2 className="text-xl font-bold tracking-tight">Welcome to HostPilot</h2>
          ...
          {slide === 1 && (
            <div className="space-y-3 text-center">
              <h2 className="text-xl font-bold tracking-tight">Block-Scope Safety</h2>
              <p className="text-xs text-muted-foreground leading-5">
                HostPilot protects your configuration files by injecting entries exclusively inside delimited scopes. 
                Your existing hosts file records are preserved untouched!
              </p>
          ...
          {slide === 2 && (
            <div className="space-y-3 text-center">
              <h2 className="text-xl font-bold tracking-tight">Elevated Permissions</h2>
              <p className="text-xs text-muted-foreground leading-5">
                Modifying the hosts file requires system admin privileges. 
                To avoid password prompts on every save, you can make the hosts file writable by running this terminal command:
              </p>
              <div className="flex items-center gap-2 bg-muted/60 rounded-lg p-2.5 border border-border">
                ...
                <Button variant="ghost" size="icon" className="h-7 w-7 text-muted-foreground" onClick={handleCopyCommand}>
